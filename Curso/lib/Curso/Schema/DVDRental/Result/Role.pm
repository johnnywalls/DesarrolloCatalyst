use utf8;
package Curso::Schema::DVDRental::Result::Role;
...
Composing rels: L</staff_roles> -> staff

=cut

__PACKAGE__->many_to_many("staffs", "staff_roles", "staff");


# Created by DBIx::Class::Schema::Loader v0.07043 @ 2015-09-18 01:41:01
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1yGEJoreqPyide7PUOhDeQ
